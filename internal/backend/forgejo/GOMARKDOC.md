...
- [type Client](<#Client>)
  ...
  - [func \(c \*Client\) UpsertReleasePR\(context.Context, backend.UpsertReleasePRRequest\) \(backend.ReleasePR, error\)](<#Client.UpsertReleasePR>)
...
### func \(\*Client\) [UpsertReleasePR](<https://github.com/brpaz/draftsman/blob/main/internal/backend/forgejo/forgejo.go#L122>)

```go
func (c *Client) UpsertReleasePR(context.Context, backend.UpsertReleasePRRequest) (backend.ReleasePR, error)
```

UpsertReleasePR implements backend.Backend. Not yet implemented — see ticket 08 of .scratch/pr\-release\-strategy/spec.md.
